...
ITEM_ALIASES = {
    ...
    "adventurer's lantern": ['schwebende laterne'],
    # letzte Lücke geschlossen (2026-06-04): neue FK-/SciFi-Items
    'bag of holding': ['tasche des fassens'],
    'cloak of protection': ['umhang des schutzes'],
    'sunrod': ['sonnenstab'],
    'grave dust': ['grabstaub'],
    'hex bag': ['hexenbeutel'],
    'war horse': ['streitross'],
    'war horse with padded barding': ['streitross'],
    'padded barding': ['wattierter rossharnisch'],
    'potion of darksight': ['trank: dunkelsicht'],
    'potion of growth': ['trank: wachstum'],
    'potion of invisibility': ['trank: unsichtbarkeit'],
    'potion of recharge': ['trank: machtpunkte aufladen'],
    'potion of wall walking': ['trank: wandkrabbler'],
    # SciFi
    'alter wear': ['wandelkleidung'],
    'line projector': ['linienprojektor'],
