...
tlog = open('logs/gepeinigter_trace.txt', 'w', encoding='utf-8')
...
try:
    s = d.Sitzung('Deadlands', 'Gepeinigter', protokoll='logs/gepeinigter.log')
    ...
    b = s.bericht('logs/gepeinigter_bericht.json')
