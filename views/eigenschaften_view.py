...
from kivymd.uix.progressindicator.progressindicator import \
    MDCircularProgressIndicator  # Aktualisierter Import für 2.0.1
...
def load_kv_file():
    ...
    kv_name = 'eigenschaften_view_mobile.kv' if mobile else 'eigenschaften_view.kv'
    ...
    if os.path.exists(kv_path):
        ...
        Logger.info(f"eigenschaften_view: KV-Datei geladen: {os.path.basename(kv_path)}")
    else:
