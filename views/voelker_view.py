...
from views.voelker_view_zusatzelemente import ZusatzelementeMixin
from views.voelker_view_halbelf import HalbelfMixin
from views.voelker_view_mensch import MenschenVielseitigMixin
...
class VoelkerWidget(ZusatzelementeMixin, HalbelfMixin, MenschenVielseitigMixin, MDBoxLayout):
    """
