    ...
    def _initialize_schritte(self):
        ...
        self.schritte = [
            ...
            WizardSchritt(
                ...
                description='Wähle das Volk deines Charakters.\n\nJedes Volk hat besondere Fähigkeiten und Boni.',
                popup_title='Abstammung & Völker',
                popup_text='Settings können alles von Menschen bis zu seltsamen Aliens, anmutigen Elfen oder anderen exotischen Völkern enthalten. Du kannst jede Abstammung spielen, die in deinem Setting verfügbar ist.\n\nJedes Volk bringt besondere Fähigkeiten mit – einige erhöhen Attribute, andere geben spezielle Fertigkeiten oder Vorteile.\n\nDie Boni werden automatisch verrechnet.',
                is_required=True,
