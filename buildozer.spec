...
source.include_patterns = assets/*,views/*.kv,templates/*,config/*,settings/*,chars/Archetypen/*,chars/Archetypen/**

# (list) Source files to exclude (let empty to not exclude anything)
#source.exclude_exts = spec

# (list) List of directory to exclude (let empty to not exclude anything)
source.exclude_dirs = tests, bin, venv, .buildozer, __pycache__, .git, Texte, logs, dist, screenshots
...
requirements = python3==3.11.13,kivy==2.3.1,https://github.com/kivymd/KivyMD/archive/365aa9b96eee63e0e29c04de297dd222f478fce5.zip,materialyoucolor==2.0.10,exceptiongroup,asyncgui,asynckivy,pillow
...
# Play Store verlangt beide ARM-Architekturen
...
# Play Store verlangt AAB-Format für neue Apps
